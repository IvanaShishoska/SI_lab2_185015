...
class SILab2Test {
    ...
    User user5= new User("username","password", "email@email.com");
    ...
    void testEveryPath() {
        ...
        // A, B, K, END
        assertTrue(!SILab2.function(user6,createUserList("user")));

        // A, B, C, D, Dcond, I, K, END //prazen string za email
        assertTrue(!SILab2.function(user7,createUserList("user")));

        // A, B, C, D, Dcond, E, F, G, H, Dmodif, Dcond, I, J, END
        assertTrue(SILab2.function(user5,createUserList("user","username1")));

        // A, B, C, D, Dcond, E, F, G, Dmodif, Dcond, I, K, END
        assertTrue(!SILab2.function(user3,createUserList("user","username1")));

        // A, B, C, D, Dcond, E, G, H, Dmodif, Dcond, I, K, END
        assertTrue(!SILab2.function(user4,createUserList("user","username1")));

        // A, B, C, D, Dcond, E, G, Dmodif, Dcond, I, K, END
        assertTrue(!SILab2.function(user2,createUserList("user","username1")));
    }
    ...
    void testMultipleCondition(){
        ...
        // T && T && F => F username!=null, email!=null list  contains
        assertTrue(!SILab2.function(user5,createUserList("username")));

        // T && T && T => T username!=null, email!=null list doesnt contain
        assertTrue(SILab2.function(user5,createUserList("user","username1")));
